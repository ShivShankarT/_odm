                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: <Widget>[
                                  Text('${data.currencySymbol}${data.invoiceTotal
                                  }')
                                ],
                              ),
                            ),
                            Padding(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: <Widget>[Text('${data.invoiceDate}')],
                              ),
                            ),
                            Padding(
                              padding:
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: <Widget>[Text('${data.invoiceNo}')],
                              ),
                            ),
                          ],
                        ),
